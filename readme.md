#### This code is not my intellectual property (see LICENCE and CODEOWNERS files). It is part of Udacity NLP nanodegree, I only contributed to some sections with the title **'IMPLEMENTATION'** of the notebook HMM_Tagger.ipynb.
